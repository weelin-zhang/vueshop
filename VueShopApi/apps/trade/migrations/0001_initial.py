# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-08-03 10:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('wait', '待支付')], default='paying', max_length=30, verbose_name='订单状态')),
